...
def calc_time(one_seg_duration, overlap):
...
def ui_full(launch_kwargs):
    with gr.Blocks(title='AudioCraft Plus', theme=theme) as interface:
            ...
            with gr.Row():
                with gr.Column():
                    with gr.Tab("Generation"):
                        ...
                        with gr.Row():
                            duration = gr.Slider(minimum=1, maximum=3000, value=300, step=1, label="Duration", interactive=True)
                        with gr.Row():
            ...
            with gr.Row():
                with gr.Column():
                    with gr.Tab("Generation"):
                        ...
                        with gr.Row():
                            duration_a = gr.Slider(minimum=1, maximum=3000, value=300, step=1, label="Duration", interactive=True)
                        with gr.Row():
        ...
        to_calc.click(calc_time, inputs=[one_seg_duration, overlap], outputs=[calcs[0], calcs[1], calcs[2], calcs[3], calcs[4], calcs[5], calcs[6], calcs[7], calcs[8], calcs[9]], queue=False)
        ...
        to_calc_a.click(calc_time, inputs=[one_seg_duration_a, overlap_a], outputs=[calcs_a[0], calcs_a[1], calcs_a[2], calcs_a[3], calcs_a[4], calcs_a[5], calcs_a[6], calcs_a[7], calcs_a[8], calcs_a[9]], queue=False)
